...
from chunkers import add_context_to_chunk
...
# A chunk that lost context during splitting
orphan_chunk = (
    "These restrictions apply to all data categories "
    "listed in section 4.2, with the exception of "
    "anonymized datasets processed after the effective "
    "date."
)

contextualized = add_context_to_chunk(
    client, sample_document, orphan_chunk
)

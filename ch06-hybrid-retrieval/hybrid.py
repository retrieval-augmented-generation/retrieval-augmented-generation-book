# hybrid.py - Keyword retrieval, semantic retrieval, and candidate-pool merge
import sys
...
def keyword_search(
    ...
    """Top-K candidates from PostgreSQL full-text search ranked by ts_rank_cd."""
...
def semantic_search(
    ...
    """Top-K candidates from pgvector cosine similarity."""
...
def hybrid_candidates(
    ...
    """Pool keyword and semantic candidates, deduplicated by chunk_id."""
